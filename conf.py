# -*- coding: utf-8 -*-
# build configuration file, created by on Fri May  5 20:26:22 2017.
...
project   = u'Coding Style'
copyright = u'2019, GKIDE'
author    = u'Charlie WONG'
...
htmlhelp_basename = 'CodingStyleDocs'
...
latex_documents = [
    (master_doc, 'CodingStyle.tex',
	u'Coding Style', author, 'manual'),
]
...
latex_engine = 'pdflatex'   # – PDFLaTeX (default)
#latex_engine = 'xelatex'   # – XeLaTeX
#latex_engine = 'lualatex'  # – LuaLaTeX
#latex_engine = 'platex'    # – pLaTeX (default if language is 'ja')
# ---------------------------------------------------------------------------- man configuration
# One entry per manual page. List of tuples
# (source start file, name, description, authors, manual section).
man_pages = [
    (master_doc, 'CodingStyle', u'Coding Style', author, 1)
]
...
texinfo_documents = [
    (master_doc, 'CodingStyle',
	u'Coding Style', author, 'CodingStyle',
	'People read first, then the machine, so be generous!',
    'Miscellaneous'),
]
